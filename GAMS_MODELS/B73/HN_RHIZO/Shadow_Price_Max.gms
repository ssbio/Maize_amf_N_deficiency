...
$include "B73_HN_RHIZO_upper_bound.txt"

    v_min(j)        Minimum reaction flux

$include "B73_HN_RHIZO_lower_bound.txt"
...
biomass_enforcement_1..
    ...
    v('Root_Biomass[R]') =g= 3.017;


biomass_enforcement_2..

    v('Shoot_Biomass[S]') =g= 0.754;


biomass_enforcement_3..

    v('Seed_Biomass[K]') =g= 2.263;


biomass_enforcement_4..

    v('Leaf_Biomass[L]') =g= 1.508;
...
FILE RESULTS /B73_HN_RHIZO_shadow_prices.txt/;
