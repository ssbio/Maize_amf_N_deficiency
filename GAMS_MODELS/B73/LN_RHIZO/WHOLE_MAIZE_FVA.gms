...
$include "B73_LN_RHIZO_upper_bound.txt"

	v_min(j)				minimum flux of v(j)

$include "B73_LN_RHIZO_lower_bound.txt"
...
biomass_enforcement_1(j)..
    v('Root_Biomass[R]')  =g= 2.879;

biomass_enforcement_2(j)..
    v('Shoot_Biomass[S]') =g= 0.719;

biomass_enforcement_3(j)..
    v('Seed_Biomass[K]')  =g= 2.159;

biomass_enforcement_4(j)..
    v('Leaf_Biomass[L]')  =g= 1.439;
...
FILE RESULTS /B73_LN_RHIZO_FVA.txt/;
