*************************************************************
*Basic FVA model for Maize_Endosperm
*************************************************************
*****************Nicholas Ampimah************************
*************************************************************
$INLINECOM /*  */
...
$include "LO3_HN_RHIZO_upper_bound.txt"

	v_min(j)				minimum flux of v(j)

$include "LO3_HN_RHIZO_lower_bound.txt"
...
biomass_enforcement_1(j)..
    v('Root_Biomass[R]')  =g= 3.143;

biomass_enforcement_2(j)..
    v('Shoot_Biomass[S]') =g= 0.785;

biomass_enforcement_3(j)..
    v('Seed_Biomass[K]')  =g= 2.357;

biomass_enforcement_4(j)..
    v('Leaf_Biomass[L]')  =g= 1.571;
...
FILE RESULTS /LO3_HN_RHIZO_FVA.txt/;
