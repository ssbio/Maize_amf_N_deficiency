*************************************************************
*Basic FVA model for whole maize
*************************************************************
*****************Nicholas Ampimah************************
*************************************************************
$INLINECOM /*  */
...
$include "LO3_LN_RHIZO_upper_bound.txt"

	v_min(j)				minimum flux of v(j)

$include "LO3_LN_RHIZO_lower_bound.txt"
...
biomass_enforcement_1(j)..
    v('Root_Biomass[R]')  =g= 2.283;

biomass_enforcement_2(j)..
    v('Shoot_Biomass[S]') =g= 0.570;

biomass_enforcement_3(j)..
    v('Seed_Biomass[K]')  =g= 1.712;

biomass_enforcement_4(j)..
    v('Leaf_Biomass[L]')  =g= 1.141;
...
FILE RESULTS /LO3_LN_RHIZO_FVA.txt/;
